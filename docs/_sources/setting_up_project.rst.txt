...
on git for `learning version control <https://www.atlassian.com/git/tutorials/what-is-version-control>`_ and
`what is git <https://www.atlassian.com/git/tutorials/what-is-git>`_.